 ...
 * Original file: /home/alex/android/frameworks/base/core/java/android/bluetooth/IBluetoothDun.aidl
 */
...
public static abstract class Stub extends android.os.Binder implements android.bluetooth.IBluetoothDun
{
private static final java.lang.String DESCRIPTOR = "android.bluetooth.IBluetoothDun";
...
/**
 * Cast an IBinder object into an android.bluetooth.IBluetoothDun interface,
 * generating a proxy if needed.
 */
public static android.bluetooth.IBluetoothDun asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof android.bluetooth.IBluetoothDun))) {
return ((android.bluetooth.IBluetoothDun)iin);
}
return new android.bluetooth.IBluetoothDun.Stub.Proxy(obj);
}
...
private static class Proxy implements android.bluetooth.IBluetoothDun
{
...
static final int TRANSACTION_getConnectionState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 1);
