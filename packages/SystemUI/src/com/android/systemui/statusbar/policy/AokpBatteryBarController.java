...
public class AokpBatteryBarController extends LinearLayout {
    ...
    public AokpBatteryBarController(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void addBars() {
        ...
        if (mStyle == STYLE_REGULAR) {
            addView(new AokpBatteryBar(mContext, mBatteryCharging, mBatteryLevel, isVertical),
                    new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT,
                            LayoutParams.MATCH_PARENT, 1));
        } else if (mStyle == STYLE_SYMMETRIC) {
            AokpBatteryBar bar1 = new AokpBatteryBar(mContext, mBatteryCharging, mBatteryLevel, isVertical);
            AokpBatteryBar bar2 = new AokpBatteryBar(mContext, mBatteryCharging, mBatteryLevel, isVertical);
